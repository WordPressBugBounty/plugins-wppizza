...
class WPPIZZA_MODULE_ADDITIVES{
	...
	*********************************************************/
	...
	function admin_options_settings($settings, $sections, $fields, $inputs, $help){
		...
		/*section*/
		if($sections){
			$settings['sections'][$this->section_key] =  __('Additives', 'wppizza-admin');
		}
		/*help*/
		if($help){
	...
	****************************************************************/
	function options_default($options){
		...
		*/
		...
		/* allow filtering */
		$options[$this->section_key] = apply_filters('wppizza_filter_install_default_additives', $options[$this->section_key]);
